...
@pytest.mark.parametrize(
    "options, expected",
    [
        ({}, ' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -X ""'),
        ({"dehint": True}, " -d"),
        ({"fallback_stem_width": 200}, (
            ' -l 8 -r 50 -G 200 -x 14 -H 200 -D latn -f none -w G -X ""')),
        ({"control_name": os.path.join("src", "my_control_file.txt")},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none'
          ' -m "my_control_file.txt" -w G -X ""')),
        ({"reference_name": os.path.join("build", "MyFont-Regular.ttf"),
          "reference_index": 1},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none'
          ' -R "MyFont-Regular.ttf" -Z 1 -w G -X ""')),
        ({"gray_strong_stem_width": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w gG -X ""')),
        ({"dw_cleartype_strong_stem_width": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w GD -X ""')),
        ({"gdi_cleartype_strong_stem_width": False},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w "" -X ""')),
        ({"windows_compatibility": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -W -X ""')),
        ({"adjust_subglyphs": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -p -X ""')),
        ({"hint_composites": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -c -X ""')),
        ({"symbol": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -s -X ""')),
        ({"fallback_scaling": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -S -X ""')),
        ({"TTFA_info": True},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -t -X ""')),
        ({"x_height_snapping_exceptions": "6,13-17"},
         (' -l 8 -r 50 -G 200 -x 14 -D latn -f none -w G -X "6,13-17"')),
    ],
    ids=[
        "default",
        "dehint",
